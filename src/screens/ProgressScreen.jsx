      ...
      {loadState === 'loading' ? (
        ...
        <>
          ...
          <section className="progress-stats">
            <article className="progress-stat-main"><Dumbbell size={24} /><span>Total workouts</span><strong>{summary.workouts}</strong><small>{hasSampleHistory ? 'temporary, clearly labelled demo history' : accountMode ? 'from your account only' : 'saved in this browser'}</small></article>
            ...
            <article><Trophy size={22} /><span>Total tracked reps</span><strong>{summary.reps}</strong><small>across camera exercises</small></article>
