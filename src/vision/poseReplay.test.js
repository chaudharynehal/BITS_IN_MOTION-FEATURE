...
describe('crunch replay corpus', () => {
  it.each([
    ...
    ['abrupt tracking reacquisition', withVisibilityDrop(crunchSequence({ reps: 2 }), { fromMs: 2100, toMs: 3200, indexes: [11, 12, 23, 24, 25, 26] }), 2],
...
describe('jumping-jack replay corpus', () => {
  it.each([
    ...
    ['overhead landmark loss', withVisibilityDrop(jumpingJackSequence(), { fromMs: 850, toMs: 1250, indexes: [15, 16] }), 1],
